          ...
          <>
            {selectedTask === 'translation' ?
              ...
              <div className="mt-4 w-full max-w-3xl">
                <ScrollArea
                  className='mb-2 h-[570px]  px-2 pb-2'
                  ref={ref}
                >
                  {messages.map(m => (
                    <div key={m.id} className=' whitespace-pre-wrap'>
                      ...
                      {m.role === 'assistant' && (
                        //@ts-ignore
                        <div className='mb-6 flex gap-3' onMouseOver={(e) => e.currentTarget.getElementsByClassName('avatarImage')[0].src = '/animated-robot.gif'} onMouseOut={(e) => e.currentTarget.getElementsByClassName('avatarImage')[0].src = '/robot.png'}>
                          <Avatar>
                            <AvatarImage className='avatarImage' src={isLoading && m.id === messages[messages.length - 1].id ? '/animated-robot.gif' : '/robot.png'}
                ...
                <form onSubmit={handleSubmit} className='absolute w-full max-w-3xl mx-auto bottom-2 left-0 right-0 mb-2'>
